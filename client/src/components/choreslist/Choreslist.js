                        ...
                        <Form>
                            ...
                            <Form.Row>
                                <Form.Group as={Col} md="6" controlId="formHouseholdMember">
                                    ...
                                    <Form.Control as="select" name="householdMemberId" value={this.state.householdMemberId}
                            ...
                            <Form.Row>
                                <Form.Group as={Col} md="6" controlId="addchores">
                                    <Form.Label>Add Chore:</Form.Label>
                                    <Form.Control as="select" name="addchoreId" value={this.state.addchoreId}
                                        onChange={this.handleInputChange}
                                    >
                                        {
                                            this.state.householdMembers.map(member => (
                                        ...
                                        <div class="col-12 city">
                                            <button class="btn btn-light">Atlanta</button>
                                        </div>
                                        <div class="col-12 city">
                                            <button class="btn btn-light">Memphis</button>
                                        </div>
                                        <div class="col-12 city">
                                            <button class="btn btn-light">Boston</button>
                                        </div>
                                    </Form.Control>
                                </Form.Group>
                            </Form.Row>
